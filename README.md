...
```javascript
map5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map5d@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-map5d@v0.2.0-umd/browser.js"></script>
```
